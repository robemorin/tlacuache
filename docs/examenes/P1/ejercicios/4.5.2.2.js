...
export async function generar(i) {
    ...
    <div class="ib-texto">
        ...
        <ol class="ib-lista" type="a">
            <li>Escriba dos ecuaciones, en función de $\\mu$ y $\\sigma$, utilizando los valores tipificados de $Z$ correspondientes a las probabilidades dadas.
            ...
            <li>A partir de sus ecuaciones, deduzca el valor de $\\mu$ y el de $\\sigma$.
                <div class="ib-mark">[4]</div>
                <tlacuache-renglon></tlacuache-renglon>
                <tlacuache-renglon></tlacuache-renglon>
                <tlacuache-renglon></tlacuache-renglon>
    ...
    <div class="ib-texto">
        ...
        <ol class="ib-lista" type="a">
            <li>
                ...
                Ecuación 1: $\\frac{\${x1} - \\mu}{\\sigma} = \${z1.toFixed(3)} \\implies \${x1} - \\mu = \${z1.toFixed(3)}\\sigma$<br><br>
                ...
                Ecuación 2: $\\frac{\${x2} - \\mu}{\\sigma} = \${z2.toFixed(3)} \\implies \${x2} - \\mu = \${z2.toFixed(3)}\\sigma$
            </li>
            <li>
